...
if __name__ == '__main__':
    resolution = 32
    seed = 12
    filename = f'{seed}-res{resolution}.jpg'
    main(low_res_pkl='original.pkl', high_res_pkl='watercolour.pkl', resolution=resolution, seed=seed, output_grid=filename, output_pkl=f'blended-res{resolution}.pkl')
